...
export default function AdminUsersPage() {
  ...
  if (!user) return (
    <div className="h-screen w-screen bg-dc-bg-primary flex items-center justify-center text-white">
  ...
  return (
    <div className="h-screen w-screen bg-dc-bg-primary text-white p-6">
